...
@section('content')
    ...
    <div style="height: 50vh;overflow-y: hidden" class="featured-top-img">
        <div class="featured-center-cropped">
        </div>
    </div>
...
{{--    </div>--}}
    ...
    <style>
        ...
        .featured-center-cropped {
            ...
            background-size: cover;
            background-position: 10% 90%;
            background-image: url('{{asset('images/background/5.jpg')}}');
